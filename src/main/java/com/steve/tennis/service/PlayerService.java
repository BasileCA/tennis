...
import com.steve.tennis.Player;
import com.steve.tennis.PlayerList;
import com.steve.tennis.PlayerToSave;
...
public class PlayerService {
    ...
    public List<Player> getAllPlayers() {
        return PlayerList.ALL.stream()
                .sorted(Comparator.comparing(player -> player.rank().positon()))
